...
@app.route('/count_chewing', methods=['POST'])
def counting():
...
def count_chewing():
    ...
    video_path = "../../Yolo/yolov5/data/videos/test2.mp4"
    video_file.save(video_path)

    # counting 함수 실행
    chewing_count = counting(video_path)

    # 결과를 JSON 형태로 반환
    return jsonify({'chewing_count': chewing_count})
